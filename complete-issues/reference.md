---
title: Referencia detallada
---

# Referencia detallada del workflow
...
- Issue por defecto: estado "To Do" si no se especifica
- Leer `/mnt/project/project-context.md` antes de iniciar
