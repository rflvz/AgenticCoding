...
3. **SIEMPRE trabaja con branches y Pull Requests** cuando sea posible (nunca en main/master directamente)
4. **Implementa la solución completa** con código real
5. **Verifica que funciona** antes de poner en revisión
6. **SIEMPRE mueve a "In Review"** después de implementar - NO marques como "Done" sin visto bueno
7. **NUNCA marques como "Done"** sin aprobación explícita del usuario
8. **Documenta el trabajo** realizado
